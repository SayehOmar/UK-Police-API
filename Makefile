...
SOURCES = \
	__init__.py \
	UK Police API.py UK Police API_dialog.py

PLUGINNAME = UK Police API

PY_FILES = \
	__init__.py \
	UK Police API.py UK Police API_dialog.py

UI_FILES = UK Police API_dialog_base.ui
...
QGISDIR=C:\Users\sayeh omar\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
